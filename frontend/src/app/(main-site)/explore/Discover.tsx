...
// }
//
// Set search value to be pulled from getAllPosts()
// Iterate over objects in posts array
// Grab value from postContent in object
// Use regEx if search query exists in postContent and display posts
//
// export function Discover(props : PostFormProps) {
