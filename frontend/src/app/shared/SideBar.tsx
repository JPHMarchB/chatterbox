...
export async function SideBar(props : Props) : Promise<JSX.Element> {
    ...
    return (
        <nav className='sticky left-0 top-[5.14rem] z-50'>
            <section className='hidden lg:block float-left px-16 py-16 text-center bg-black border-e me-5'>
                ...
                <div className='grid *:py-4 pt-9 text-white'>
                    ...
                    <a href='/profile' className='hover:bg-gray-900 rounded-xl'>Settings</a>
                    <SignOutButton/>
                </div>
            </section>
        </nav>
